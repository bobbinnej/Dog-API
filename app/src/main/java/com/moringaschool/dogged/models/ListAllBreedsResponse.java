...
public class ListAllBreedsResponse {
    ...
    public class Message {
        ...
        public Message(List<Object> affenpinscher, List<Object> african, List<Object> airedale, List<Object> akita, List<Object> appenzeller, List<String> australian, List<Object> basenji, List<Object> beagle, List<Object> bluetick, List<Object> borzoi, List<Object> bouvier, List<Object> boxer, List<Object> brabancon, List<Object> briard, List<String> buhund, List<String> bulldog, List<String> bullterrier, List<String> cattledog, List<Object> chihuahua, List<Object> chow, List<Object> clumber, List<Object> cockapoo, List<String> collie, List<Object> coonhound, List<String> corgi, List<Object> cotondetulear, List<Object> dachshund, List<Object> dalmatian, List<String> dane, List<String> deerhound, List<Object> dhole, List<Object> dingo, List<Object> doberman, List<String> elkhound, List<Object> entlebucher, List<Object> eskimo, List<String> finnish, List<String> frise, List<Object> germanshepherd, List<String> greyhound, List<Object> groenendael, List<Object> havanese, List<String> hound, List<Object> husky, List<Object> keeshond, List<Object> kelpie, List<Object> komondor, List<Object> kuvasz, List<Object> labradoodle, List<Object> labrador, List<Object> leonberg, List<Object> lhasa, List<Object> malamute, List<Object> malinois, List<Object> maltese, List<String> mastiff, List<Object> mexicanhairless, List<Object> mix, List<String> mountain, List<Object> newfoundland, List<Object> otterhound, List<String> ovcharka, List<Object> papillon, List<Object> pekinese, List<Object> pembroke, List<String> pinscher, List<Object> pitbull, List<String> pointer, List<Object> pomeranian, List<String> poodle, List<Object> pug, List<Object> puggle, List<Object> pyrenees, List<Object> redbone, List<String> retriever, List<String> ridgeback, List<Object> rottweiler, List<Object> saluki, List<Object> samoyed, List<Object> schipperke, List<String> schnauzer, List<String> setter, List<String> sheepdog, List<Object> shiba, List<Object> shihtzu, List<String> spaniel, List<String> springer, List<Object> stbernard, List<String> terrier, List<Object> tervuren, List<Object> vizsla, List<String> waterdog, List<Object> weimaraner, List<Object> whippet, List<String> wolfhound) {
            super();
